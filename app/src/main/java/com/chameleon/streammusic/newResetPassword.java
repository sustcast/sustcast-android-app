...
public class newResetPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmail = (EditText) findViewById(R.id.sendEmail);
        mPassword = (EditText) findViewById(R.id.sendPassword);
        mCpassword = (EditText) findViewById(R.id.sendCpassword);
        mToken = (EditText) findViewById(R.id.sendToken);
        mSend = (Button) findViewById(R.id.sendInfo);
        spinner = (ProgressBar) findViewById(R.id.pBarresetnew);
